...
GO_BACK_IMAGE_PATH = 'icons\\backward-solid.png'
GO_FORWARD_IMAGE_PATH = 'icons\\forward-solid.png'
PLAY_SONG_IMAGE_PATH = 'icons\\play-solid.png'
PAUSE_SONG_IMAGE_PATH = 'icons\\pause-solid.png'
ALBUM_COVER_IMAGE_PATH = 'icons\\play-solid.png'
...
window = sg.Window('APS', layout=main, size=(
